...
//   const ref = useRef(null);
//   const { startDragging, stopDragging } = useDragOverlay();
//   const getLeastUsedLetter = useGameState((state) => state.getLeastUsedLetter);
//   const leastUsedLetter = getLeastUsedLetter();
//   const { letterGrid } = useGameState.getState(); // Access the global grid state

//   const [{ isDragging }, drag] = useDrag(() => ({
//     type: "tile",
//     item: () => {
//       // Dynamically fetch the latest letter from the grid state
//       const currentLetter = letterGrid[position[0]][position[1]];
//       console.log(`Drag started for letter: ${currentLetter}, position: ${position}`);
//       startDragging(currentLetter);
//       return { letter: currentLetter, position };
...
//   // Dynamically fetch the current letter to display in the tile
//   const currentLetter = letterGrid[position[0]][position[1]];
...
//       ref={ref}
//       className={`p-4 m-1 ${
//         currentLetter === leastUsedLetter ? "bg-red-500" : "bg-blue-500"
//       } text-white font-bold rounded-md shadow-md cursor-pointer ${
//         isDragging ? "opacity-50" : ""
//       }`}
//     >
...
// const LetterTile = ({ letter, position }) => {
//   const ref = useRef(null);
//   const { startDragging, stopDragging } = useDragOverlay();
//   const getLeastUsedLetter = useGameState((state) => state.getLeastUsedLetter);
//   const leastUsedLetter = getLeastUsedLetter();
...
//       ref={ref}
//       className={`tile p-4 m-1 ${
//         letter === leastUsedLetter ? "bg-red-500" : "bg-blue-500"
//       } text-white font-bold rounded-md shadow-md cursor-pointer ${
//         isDragging ? "opacity-50" : ""
//       }`}
//     >
